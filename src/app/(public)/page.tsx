          ...
          <div className="mt-8 flex flex-col gap-8 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="flex shrink-0 items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="press glass inline-flex items-center rounded-full px-6 py-3 text-sm font-medium text-neutral-200 transition-colors hover:bg-white/10 hover:text-white"
              >
                GitHub ↗
              </a>
            </div>
            ...
            <Reveal>
              ...
              >
                ...
                <div className="flex flex-col justify-center gap-4 p-7 lg:col-span-2 lg:p-10">
                  ...
                  <span className="text-sm text-sky-400">Open project ↗</span>
                </div>
              </Link>
            </Reveal>
          )}
